...
export default function App() {
  ...
  const onChange = evt => {
    ...
    //this way ensures the use of the latest state by relying on the function form of the state update, 
    //receiving the most current state.
  ...
  const submitNewMember = () => {
    ...
    //this new variable grabs, our initial values and also id from the getId() function.
    const newMember = {fname, lname, bio, id: getId()}

    //spreading the current members list and appending the new member at the end.
    //creating a new array with old and new members.
      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input onChange={onChange} id="fname" type="text" placeholder="Type First Name" value={values.fname}/>
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input onChange={onChange} id="lname" type="text" placeholder="Type Last Name" value={values.lname}/>
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea onChange={onChange} id="bio" placeholder="Type Bio" value={values.bio}/>
          </div>
